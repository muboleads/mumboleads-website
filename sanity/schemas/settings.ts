export default {
  ...
  fields: [
    ...
    {
      name: 'showFAQ',
      title: 'Show FAQ Section on Homepage',
      type: 'boolean',
      description: 'Toggle to show/hide FAQ section on homepage',
      initialValue: true,
    },
    {
      name: 'faqSection',
    ...
    {
      name: 'showHowItWorks',
      title: 'Show How It Works Section on Homepage',
      type: 'boolean',
      description: 'Toggle to show/hide How It Works section on homepage',
      initialValue: true,
    },
    {
    ...
    {
      name: 'showPricing',
      title: 'Show Pricing Section on Homepage',
      type: 'boolean',
      description: 'Toggle to show/hide Pricing section on homepage',
      initialValue: true,
    },
    {
      name: 'pricingSection',
      title: 'Pricing Section Headings',
      type: 'object',
      fields: [
        {
          name: 'title',
        ...
        },
        {
          ...
          type: 'text',
          rows: 2,
          initialValue: 'Clear pricing, no surprises. Every project is scoped individually for your unique needs.',
        },
        {
          name: 'badge',
          title: 'Badge Text',
          ...
          initialValue: 'Transparent rates',
        },
      ],
    },
    {
      name: 'showCaseStudies',
      title: 'Show Case Studies in Navigation',
      type: 'boolean',
      description: 'Toggle to show/hide Case Studies menu item',
      initialValue: true,
    },
    {
      name: 'showBlog',
      ...
      type: 'boolean',
      description: 'Toggle to show/hide Blog menu item',
      initialValue: true,
    },
    {
      name: 'showAboutSection',
      title: 'Show About Section on Homepage',
      type: 'boolean',
      description: 'Toggle to show/hide About/Founder section on homepage',
      initialValue: true,
    },
    {
      name: 'showAbout',
      ...
      type: 'boolean',
      description: 'Toggle to show/hide About menu item',
      initialValue: true,
    },
    {
      name: 'defaultSeo',
